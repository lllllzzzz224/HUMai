...
rois=[[175,110,220,145],[115,190,155,230],[365,265,405,310],[375,330,405,370]]
allpts=[];stats=[]
for rec in c['records']:
 ...
 for ri,(x0,y0,x1,y1) in enumerate(rois):
  ...
  good=(z>.1)&(z<2);xyz=np.stack(((xx-K[0,2])*z/K[0,0],(yy-K[1,2])*z/K[1,1],z),axis=-1)[good]
