...
p=Path('/home/li/桌面/9月机械臂实验（算法）/reports/birdview_alignment_20260916');data=(p/'trajectory.cdr').read_bytes();jt=deserialize_message(data,RobotTrajectory).joint_trajectory
...
Path('/home/li/桌面/9月机械臂实验（算法）/reports/birdview_alignment_review_20260916/spline_review.json').write_text(json.dumps(r,indent=2));print(json.dumps(r,indent=2))
