...
src=Path(__file__).resolve().parent.parent/'alignment_20260916'
c=json.loads((src/'capture.json').read_text());rois=[[250,275,300,305],[395,285,425,310],[270,125,295,150]];rows=[];allp=[]
for r in c['records']:
