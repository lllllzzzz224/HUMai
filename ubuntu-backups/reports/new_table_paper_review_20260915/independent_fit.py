...
src=Path(__file__).resolve().parent.parent/'new_table_paper_20260915'
c=json.loads((src/'capture.json').read_text());rois=[[150,155,190,190],[365,315,410,345],[340,240,365,260]];rows=[];allp=[]
for r in c['records']:
