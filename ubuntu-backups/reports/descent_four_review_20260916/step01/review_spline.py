...
p=Path('/home/li/桌面/9月机械臂实验（算法）/reports/vertical_diagnostic20_20260916/four_step_plan/step01');data=(p/'trajectory.cdr').read_bytes();jt=deserialize_message(data,RobotTrajectory).joint_trajectory
...
Path('/home/li/桌面/9月机械臂实验（算法）/reports/descent_four_review_20260916/step01/spline_review.json').write_text(json.dumps(r,indent=2));print(json.dumps(r,indent=2))
